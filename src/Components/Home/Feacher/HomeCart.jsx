...
const HomeCart = ({ cart }) => {
  return (
    <div className="max-w-75 mx-auto w-full h-full p-4 border border-[#808080] rounded-2xl flex flex-col justify-between gap-2 bg-white">
      <div className="flex flex-col gap-2">
        <div className="h-52 border border-[#0041FF] rounded-2xl overflow-hidden shrink-0">
          <ImageCompare url1={cart?.img?.rawImg} url2={cart?.img?.edited} />
        </div>
        <div className="text-left flex flex-col gap-1 mt-2">
