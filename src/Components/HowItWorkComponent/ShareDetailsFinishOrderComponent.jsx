...
import ShareDetailsFinishOrder from "../../assets/ShareDetailsFinishOrder.svg";

const ShareDetailsFinishOrderComponent = () => {
  return (
    <div className=" rounded-2xl flex flex-col lg:flex-row justify-between items-center ">
      <img className="h-full" src={ShareDetailsFinishOrder} alt="" />
...
export default ShareDetailsFinishOrderComponent;
